...
public interface HardwareStateMapper {
    ...
    Hardware getByIdAndType(@Param("id") String id, @Param("type") String type);

    @Select("SELECT * FROM hardware_state WHERE type=#{type};")
    List<Hardware> getAllByType(@Param("type") String type);
    ...
    int openByIdAndType(@Param("id") String id, @Param("type") String type);
